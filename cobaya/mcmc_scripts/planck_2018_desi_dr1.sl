...
### LCDM
#YAMLFILE=${YAMLFOLDER}lcdm_P18_bao_desi_dr1.yaml
YAMLFILE=${YAMLFOLDER}lcdm_P18_bao_desi_dr1_classig.yaml
...
### IG
#YAMLFILE=${YAMLFOLDER}ig_V0_P18_bao_desi_dr1.yaml
#YAMLFILE=${YAMLFOLDER}ig_V4_P18_bao_desi_dr1.yaml
